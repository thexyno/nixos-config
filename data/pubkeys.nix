  ...
  ragon =
    let
      ...
      host = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJ+BBXufXAJhyUHVfhqlk8Y4zEKJbKXgJQvsdE482lpV" # ds9 hostkey

      ] ++ hosts.wormhole;
      hosts = {
        wormhole = ["ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIO7Ab/50Bg9EncYbobC6kzdDzCDgvM1Tlf/9d+SDkO15"]; # wormhole hostkey
      };
    in
    {
      inherit pc work hosts;
